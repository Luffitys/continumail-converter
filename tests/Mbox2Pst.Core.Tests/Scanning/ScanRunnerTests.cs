...
namespace Mbox2Pst.Core.Tests.Scanning;
...
public class ScanRunnerTests
{
    ...
    {
        string dirA = Path.Combine(Path.GetTempPath(), "mbox2pst-scan-" + Guid.NewGuid());
        string dirB = Path.Combine(Path.GetTempPath(), "mbox2pst-scan-" + Guid.NewGuid());
