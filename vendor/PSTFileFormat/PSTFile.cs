...
namespace PSTFileFormat
{
    public partial class PSTFile
    {
        ...
        /// <summary>
        /// In-memory AMap page cache used by AllocationHelper to avoid re-reading and
        /// re-scanning AMap pages from disk on every allocation/free. Populated lazily
        /// on first use. AMapMaxFreeGeneral[i] / AMapMaxFreeAligned[i] hold the exact
        /// max-contiguous-free-bytes for AMapCache[i] (general, and starting on a
        /// 512-byte-aligned boundary, respectively).
        /// See docs/superpowers/specs/2026-06-13-allocationhelper-amap-cache-design.md.
        /// </summary>
        internal Dictionary<int, AllocationMapPage> AMapCache;
