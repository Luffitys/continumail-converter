...
$cliProj    = Join-Path $repoRoot "src\Mbox2Pst.Cli\Mbox2Pst.Cli.csproj"
...
Copy-Item (Join-Path $publishDir "Mbox2Pst.Cli.exe") `
  (Join-Path $binDir "mbox2pst-cli-x86_64-pc-windows-msvc.exe") -Force
